...
As base file format of this database was .gif, all photos you may want to upload for test algorithm you need to convert it to .gif format. Then, as files format is .wink, .happy etc
make it same. You can take a look to subject16 format to see it. It can work even if you dont convert to gif and then to .happy or other, it can work to transfer picture immediately
to .happy or other, but from speciality of .gif format the recognition result will be better if it tested on convert sequence picture->.gif->.test(or any word).	
